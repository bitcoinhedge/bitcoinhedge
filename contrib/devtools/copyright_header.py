...
EXCLUDE = [
    # auto generated:
    'src/qt/bitcoinhedgestrings.cpp',
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The BITCOINHEDGE developers'
...
Arguments:
    <base_directory> - The base directory of a bitcoinhedge source code repository.
"""
