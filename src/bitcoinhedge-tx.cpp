...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BITCOINHEDGE Core bitcoinhedge-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bitcoinhedge-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitcoinhedge transaction") + "\n" +
                               "  bitcoinhedge-tx [options] -create [commands]   " + _("Create hex-encoded bitcoinhedge transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitcoinhedge transaction
