...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop BITCOINHEDGE server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "BITCOINHEDGE server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BITCOINHEDGE features */
        {"bitcoinhedge", "listmasternodes", &listmasternodes, true, true, false},
        {"bitcoinhedge", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bitcoinhedge", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bitcoinhedge", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"bitcoinhedge", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"bitcoinhedge", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"bitcoinhedge", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bitcoinhedge", "masternodedebug", &masternodedebug, true, true, false},
        {"bitcoinhedge", "startmasternode", &startmasternode, true, true, false},
        {"bitcoinhedge", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bitcoinhedge", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bitcoinhedge", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bitcoinhedge", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bitcoinhedge", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bitcoinhedge", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bitcoinhedge", "preparebudget", &preparebudget, true, true, false},
        {"bitcoinhedge", "submitbudget", &submitbudget, true, true, false},
        {"bitcoinhedge", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bitcoinhedge", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bitcoinhedge", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bitcoinhedge", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bitcoinhedge", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bitcoinhedge", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bitcoinhedge", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bitcoinhedge", "checkbudgets", &checkbudgets, true, true, false},
        {"bitcoinhedge", "mnsync", &mnsync, true, true, false},
        {"bitcoinhedge", "spork", &spork, true, true, false},
        {"bitcoinhedge", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzbtchgseed", &getzbtchgseed, false, false, true},
        {"zerocoin", "setzbtchgseed", &setzbtchgseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzbtchg", &searchdzbtchg, false, false, true},
        {"zerocoin", "dzbtchgstate", &dzbtchgstate, false, false, true},
...
{
    return "> bitcoinhedge-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:40657/\n";
}
