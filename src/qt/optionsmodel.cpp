...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::BTCHG);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeBITCOINHEDGEAmount"))
        SoftSetArg("-anonymizebitcoinhedgeamount", settings.value("nAnonymizeBITCOINHEDGEAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in bitcoinhedge.cpp during shotdown to also remove the window positions
