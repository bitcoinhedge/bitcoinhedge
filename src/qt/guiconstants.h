...
/* BITCOINHEDGE GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "BITCOINHEDGE"
#define QAPP_ORG_DOMAIN "bitcoinhedge.org"
#define QAPP_APP_NAME_DEFAULT "BITCOINHEDGE-Qt"
#define QAPP_APP_NAME_TESTNET "BITCOINHEDGE-Qt-testnet"
