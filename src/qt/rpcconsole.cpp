                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzBTCHGPathCustom = GetArg("-zbtchgbackuppath", "");
    ...
    if(!strzBTCHGPathCustom.empty()) {
        ui->wallet_customzbtchgbackuppath->setText(QString::fromStdString(strzBTCHGPathCustom));
        ui->wallet_customzbtchgbackuppath_label->setVisible(true);
        ui->wallet_customzbtchgbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzBTCHGPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the BITCOINHEDGE RPC console.") + "<br>" +
