...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("BITCOINHEDGE Core"),
     ...
     * override -datadir in the bitcoinhedge.conf file in the default data directory
     * (to be consistent with bitcoinhedged behavior)
     */
    if (dataDir != getDefaultDataDirectory())
