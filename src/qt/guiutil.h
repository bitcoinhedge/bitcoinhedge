...
/** Utility functions used by the BITCOINHEDGE Qt UI.
 */
namespace GUIUtil
{
...
// Render BITCOINHEDGE addresses in monospace font
...
// Parse "bitcoinhedge:" URI into recipient object, return true on successful parsing
