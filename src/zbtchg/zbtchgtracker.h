...
#ifndef BITCOINHEDGE_ZBTCHGTRACKER_H
#define BITCOINHEDGE_ZBTCHGTRACKER_H
...
public:
    CzBTCHGTracker(std::string strWalletFile);
    ~CzBTCHGTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzBTCHGWallet* zBTCHGWallet = NULL);
...
#endif //BITCOINHEDGE_ZBTCHGTRACKER_H
