...
#ifndef BITCOINHEDGE_ZBTCHGWALLET_H
#define BITCOINHEDGE_ZBTCHGWALLET_H
...
public:
    CzBTCHGWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZBTCHG(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZBTCHG(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
...
#endif //BITCOINHEDGE_ZBTCHGWALLET_H
