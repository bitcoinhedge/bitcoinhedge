Contributing to BITCOINHEDGE Core
============================

The BITCOINHEDGE Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/bitcoinhedge-project/bitcoinhedge/blob/master/doc/translation_process.md)
...
The following applies to code changes to the BITCOINHEDGE Core project, and is not to be
confused with overall BITCOINHEDGE Network Protocol consensus changes.

Whether a pull request is merged into BITCOINHEDGE Core rests with the project merge
...
Patches that change BITCOINHEDGE consensus rules are considerably more involved than
...
Where a patchset proposes to change the BITCOINHEDGE consensus, it must have been
...
The project leader is the release manager for each BITCOINHEDGE Core release.
