...
from fake_stake.base_test import BITCOINHEDGE_FakeStakeTest

class zBTCHGValidCoinSpendTest(BITCOINHEDGE_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zBTCHGs..." % DENOM_TO_USE)
